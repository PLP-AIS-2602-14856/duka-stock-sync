...
GRANT SELECT, INSERT ON public.sync_logs TO authenticated, anon;
GRANT ALL ON public.sync_logs TO service_role;
ALTER TABLE public.sync_logs ENABLE ROW LEVEL SECURITY;
CREATE POLICY "sync_logs_read" ON public.sync_logs FOR SELECT TO anon, authenticated USING (true);
CREATE POLICY "sync_logs_insert" ON public.sync_logs FOR INSERT TO anon, authenticated WITH CHECK (true);
